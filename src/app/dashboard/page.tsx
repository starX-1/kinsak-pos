...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
      {/* Mobile Header */}
      <div className="lg:hidden sticky top-0  bg-indigo-900/90 backdrop-blur-sm border-b border-indigo-700/30 p-4">
          ...
          <div className="flex space-x-2 mb-4 lg:mb-6 overflow-x-auto pb-2">
            {categories.map((category) => (
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 lg:px-4 lg:py-3 rounded-xl font-medium transition-all whitespace-nowrap ${
